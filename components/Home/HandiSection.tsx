...
const handiData = {
  ar: {
    ...
    items: [
      "مداخل خاصه لهم بالاستقبال ",
      "وجود منحدرات تلائم الكراسي المتحركه ",
      "وجود أماكن خاصه لهم بالمواقف  الأرضيه ",
      "توجد لغة برايل في المصاعد ومساند يدويه وخدمه صوتيه للتعريف بالأدوار",
      "توجد غرفه صديقه لاحتياجات ذوي الاعاقات البصريه والسمعيه والحركيه في الطابق الول من الفندق ويرجي الحجز مسبقا ",
      "توجد نشرات ومجلدات بلغة برايل بالغرفه لشرح خدمات الفندق كامله كما توجد ملصقات علي الادوات بالغرفه ",
    ],
  },

  en: {
    title: "Handicapped Facilities",
    items: [
      "Special access in reception entrance ",
      "Special ramps for wheel chairs",
      "Special parking area at the hotel parking",
      "Brail language at the elevator’s buttons, hand rails, and voice service to identify the floors ",
      "Handicapped friendly room for Visual, voice, and movements disabilities. The room allocated at first floor and please previous booking is required ",
      "Brail Language folders and printings are available inside the room as well brail stickers at the tools inside the room",
    ],
  },
};
const HandiSection = () => {
      ...
      <section className="mt-5 mb-0 w-full relative ">
        <div className="text-center">
          <h3 className="text-center text-2xl text-primary-dark font-semibold mb-5">
            {handiData[locale].title}
          </h3>
        </div>
        <div className="grid grid-cols-2 gap-2 my-3 mx-8 items-center">
          {handiData[locale].items.map((item, i) => (
            <div
              key={i}
              className="hover:bg-gray-200 rounded-md bg-gray-100 p-4 m-2 flex"
            >
              <span className="m-2">
                <svg
                  viewBox="0 -0.5 166 166"
                  className="w-4 h-4"
                  fill="none"
