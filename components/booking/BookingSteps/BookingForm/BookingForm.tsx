      ...
      >
        ...
        */}
        ...
        <div className="w-full md:w-2/3">
          <CustomPhoneInput name="phone" register={register} />
        </div>
        {errors.phone && (
          <p
        ...
        */}
        ...
        <label
          className="mt-2 mb-1 capitalize"
          onMouseEnter={() => speechHandler(t("notes"))}
          htmlFor="notes"
        >
          {t("notes")}
        </label>
        ...
        {errors.notes && (
          <p
            onMouseEnter={() => speechHandler(errors.notes?.message[locale])}
            className="text-red-600 text-base  font-normal my-1"
          >
            {errors.notes?.message[locale]}
          </p>
        )}
        <button
