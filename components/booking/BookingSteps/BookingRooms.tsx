	...
	return (
		<div className="bg-white border border-black rounded-md shadow-sm">
			<div className="py-3 mx-auto w-full md:w-10/12 border-0 border-b border-black">
				<h3 className="text-base font-semibold">Reservation summary</h3>
			</div>
			{rooms &&
				rooms.length > 0 &&
				rooms.map((room: any, i: number) => (
					...
					>
						...
						{room?.name && (
							<>
								<h5 className="text-base font-normal my-1">
									{room?.name[locale]}
								</h5>
								<button
			...
			<div className="px-2 py-3 mx-auto w-full md:w-10/12 border-0 border-b border-black my-5">
				<div className="flex justify-between items-start my-2">
					<h5 className="text-base font-normal">Total room charges</h5>
					<h5 className="text-base font-normal">
						{totalPrice} {t('sar')}
					</h5>
				</div>
				<div className="flex justify-between items-start my-2">
					<h5 className="text-base font-normal">Total taxes</h5>
					<h5 className="text-base font-normal">126 {t('sar')}</h5>
				</div>
			</div>
			<div className="px-2 py-3 mx-auto w-full md:w-10/12 border-0 border-b flex justify-between items-start border-black my-5">
				<h5 className="text-lg font-medium">Total for stay:</h5>
