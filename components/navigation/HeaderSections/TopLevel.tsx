  ...
  return (
    <div className="flex justify-center lg:justify-between items-center mx-5 py-3 my-2 px-2">
      ...
      <div className="flex justify-center items-center">
        ...
        >
          <a className="mx-3 text-lg font-medium text-primary-dark">Join Nivel</a>
        </ActiveLink>
        <span>|</span>
        <ActiveLink activeClassName={styles.active}
          href={`/${locale}/login`}
        >
          <a className="mx-3 text-lg font-medium text-primary-dark">Sign In</a>
        </ActiveLink>
        <FontAwesomeIcon icon={faUserCircle} className="text-primary-light text-lg mt-1" />
      </div>
    </div>
  )
}
