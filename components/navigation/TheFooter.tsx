		...
		<footer className="w-full bg-gray-light px-5 py-10 mt-0 mb-0">
			<div className="mx-5 my-5 grid grid-col-1 md:grid-cols-3 gap-3 items-start">
				<div>
					...
					<p className="text-primary-light my-4 md:my-0 text-base font-normal text-left">
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corporis
						sequi dolores quia nostrum veritatis, architecto nulla adipisci
						ullam eligendi ipsum necessitatibus debitis, perspiciatis
						exercitationem quo in pariatur magni, sit cum.
					</p>
				</div>
